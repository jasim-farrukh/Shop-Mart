...
<body>
    ...
    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <img src="img/additems.jpg">
                    <br>
                    <a class="btn btn-primary btn-block" role="button" href="add_item.php">ADD Items</a>
                </div>
                <div class="col-md-4">
                    <img src="img/viewitem.jpg">
                    <br>
                    <a class="btn btn-primary btn-block" role="button" href="view_item.php">VIEW Items</a>
                </div>
                <div class="col-md-4">
                    <img src="img/homeitem.jpg">
                    <br>
